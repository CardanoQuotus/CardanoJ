...
import com.cardanoj.jna.coreapi.util.AssetUtil;
import com.cardanoj.jna.coreapi.util.UtxoUtil;
import com.cardanoj.jna.coreapi.config.Configuration;
...
import com.cardanoj.jna.function.TxInputBuilder;
import com.cardanoj.jna.function.exception.TxBuildException;
...
public class InputBuilders {
     ...
     * @param utxos         list of <code>{@link Utxo}</code>
     * @param changeAddress change address
     * @param datum         datum object. It can be an instance of <code>{@link PlutusData}</code> or object of a custom class with <code>@{@link com.cardanoj.jna.plutus.annotation.Constr}</code> annotation
     ...
     * @throws com.cardanoj.jna.plutus.exception.PlutusDataConvertionException if datum cannot be converted to PlutusData
     */
