...
import com.cardanoj.jna.function.helper.model.ScriptCallContext;
...
import static com.cardanoj.jna.function.helper.RedeemerUtil.getScriptInputIndex;
...
public class ScriptCallContextProviders {
     ...
     * @param datum Datum as PlutusData or custom Java object (with <code>{@link com.cardanoj.jna.plutus.annotation.Constr}</code> annotation)
     * @param redeemerData Redeemer as PlutusData or custom Java object (with <code>{@link com.cardanoj.jna.plutus.annotation.Constr}</code> annotation)
