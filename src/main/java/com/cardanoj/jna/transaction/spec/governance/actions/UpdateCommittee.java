package com.cardanoj.jna.transaction.spec.governance.actions;

import co.nstant.in.cbor.model.*;
import com.cardanoj.jna.address.Credential;
import com.cardanoj.jna.spec.UnitInterval;
import com.cardanoj.jna.transaction.util.CredentialSerializer;
import lombok.*;

import java.util.Map;
import java.util.*;

import static com.cardanoj.jna.common.cbor.CborSerializationUtil.toInt;
