...
import com.cardanoj.backend.model.*;
 ...
 */
public class KoiosAccountService implements com.cardanoj.backend.api.AccountService {
    ...
    private Result<List<AccountRewardsHistory>> convertToAccountRewards(List<AccountReward> accountRewardsList, OrderEnum order) {
        ...
        if (accountRewardsList != null) {
            for (AccountReward accountRewards : accountRewardsList) {
