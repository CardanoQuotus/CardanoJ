...
import com.cardanoj.backend.api.AssetService;
import com.cardanoj.backend.model.Asset;
import com.cardanoj.backend.model.AssetAddress;
import com.cardanoj.backend.model.AssetTransactionContent;
import com.cardanoj.backend.model.PolicyAsset;
...
public class KoiosAssetService implements AssetService {
    ...
    @Override
    public Result getTransactions(String asset, int count, int page, OrderEnum order) throws ApiException {
        try {
